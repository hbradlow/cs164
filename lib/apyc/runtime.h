...
#define NATIVE__truth__             return new Bool(*((int*)frame->getVar("x"))==0)
#define NATIVE__not__               return new Bool(*((int*)frame->getVar("x"))!=0)
#define NATIVE__xrange__
#define NATIVE__len__range__
#define NATIVE__add__int__          return new Integer(*((int*)frame->getVar("x"))+*((int*)frame->getVar("y")))
#define NATIVE__sub__int__          return new Integer(*((int*)frame->getVar("x"))-*((int*)frame->getVar("y")))
#define NATIVE__mul__int__          return new Integer(*((int*)frame->getVar("x"))**((int*)frame->getVar("y")))
#define NATIVE__floordiv__int__     return new Integer((int)(*((int*)frame->getVar("x"))/ *((int*)frame->getVar("y"))))
#define NATIVE__mod__int__          return new Integer(*((int*)frame->getVar("x"))%*((int*)frame->getVar("y")))
#define NATIVE__pow__int__
#define NATIVE__neg__int__          return *((int*)frame->getVar("x"))>0 ? new Integer(-*((int*)frame->getVar("x"))) : new Integer(*((int*)frame->getVar("x")))
#define NATIVE__pos__int__          return *((int*)frame->getVar("x"))<0 ? new Integer(-*((int*)frame->getVar("x"))) : new Integer(*((int*)frame->getVar("x")))
#define NATIVE__lt__int__           return new Bool(*((int*)frame->getVar("x"))<*((int*)frame->getVar("y")))
#define NATIVE__gt__int__           return new Bool(*((int*)frame->getVar("x"))>*((int*)frame->getVar("y")))
#define NATIVE__le__int__           return new Bool(*((int*)frame->getVar("x"))<=*((int*)frame->getVar("y")))
#define NATIVE__ge__int__           return new Bool(*((int*)frame->getVar("x"))>=*((int*)frame->getVar("y")))
#define NATIVE__eq__int__           return new Bool((*(int*)frame->getVar("x"))==(*(int*)frame->getVar("y")))
#define NATIVE__ne__int__           return new Bool(*((int*)frame->getVar("x"))!=*((int*)frame->getVar("y")))
