 ...
 *     value_type make_token (int syntax, const char* text, size_t len);
 *
...
public:
    ...
    static inline value_type default_make_token (int, const char*, size_t) {
...
public:
    ...
    static inline value_type default_make_token (int syntax, 
